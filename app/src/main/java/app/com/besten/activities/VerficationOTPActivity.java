...
public class VerficationOTPActivity extends AppCompatActivity {
...
//    VerifyButtonClickListener clickListenerVerify;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verfication_otp);
...
//        clickListenerVerify=new VerifyButtonClickListener();
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp.isEmpty()){
                    Toast.makeText(VerficationOTPActivity.this, "Please enter OTP. OTP is empty now", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    mauth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(VerficationOTPActivity.this, "Oh Sorry a problem occured while sending otp", Toast.LENGTH_SHORT).show();
    ...
    private void goToMainActivity() {
        ...
        Intent intent=new Intent(VerficationOTPActivity.this,MainActivity.class);
